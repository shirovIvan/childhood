...
?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        <h1 class="title underlined"><?php the_field('about_titile'); ?></h1>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('title_comand') ?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('img_comand'); ?>">
                    </div>
                </div>
            </div>
        </div>
